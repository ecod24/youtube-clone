		...
		<main>
			<div className='about'>
				...
				<p className='text'>
					...
					website Youtube.com. Our clone site has the ability to search for
				...
				<p className='text'>
					Please see the links below to connect with Edwin!
				</p>
				...
				<p className='text'>
					Please see the links below to connect with Taryne!
				</p>
